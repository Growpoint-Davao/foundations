...
fun Power2(
    ...
    LazyColumn(
        ...
        item {
            ContentMarkdown(
                markdown = stringResource(R.string.power_page_2_part_1),
            ...
            ContentMarkdown(
                markdown = stringResource(R.string.power_page_2_part_2),
                modifier = modifier.padding(
                    top = 24.dp,
                    bottom = 32.dp,
                    start = 16.dp,
            ...
            ContentMarkdown(
                markdown = stringResource(R.string.power_page_2_part_3),
                modifier = modifier.padding(
                    top = 24.dp,
                    bottom = 32.dp,
                    start = 16.dp,
